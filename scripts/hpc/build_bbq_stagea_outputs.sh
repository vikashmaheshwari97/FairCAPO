...
test -f outputs/hpc/evaluation_large/seed_0/bbq_posthoc/test_eval_summary.json
test -f outputs/hpc/evaluation_large/seed_0/bbq_posthoc/test_eval_candidates.csv
