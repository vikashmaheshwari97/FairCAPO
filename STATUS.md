...
9. **Scale budget only after seed 0 is healthy.** The active HPC config is the smaller first-run scale:
   Ddev=150, Dshots=50, Dtest=200, budget=1M tokens, z_max=5. Paper-scale is still commented in the
